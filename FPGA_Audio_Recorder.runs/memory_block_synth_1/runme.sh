...
HD_PWD='C:/Users/Owner/Desktop/FPGA_Audio_Recorder-master/FPGA_Audio_Recorder.runs/memory_block_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log memory_block.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source memory_block.tcl
